...
## O que é o projeto
O Sistema de Controle de Validade de Produtos por Lotes é um projeto pessoal de estudo, atualmente em desenvolvimento.

A ideia surgiu com o objetivo de praticar desenvolvimento Full Stack, aplicando conceitos de backend, banco de dados e organização de projetos.  
Não se trata de um sistema profissional ou comercial, mas sim de um projeto voltado para aprendizado, experimentação e evolução técnica.

## Qual problema ele resolve
O projeto busca resolver o problema enfrentado por pequenas mercearias e comércios locais, onde produtos acabam ultrapassando o prazo de validade por falta de controle adequado.

Com o controle de produtos por lotes, o sistema permite acompanhar as datas de validade de forma mais organizada, ajudando a evitar perdas, desperdícios e problemas relacionados à venda de produtos vencidos.
